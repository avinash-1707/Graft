...
/**
 * Boots OpenTelemetry tracing for the gateway. Must run before Fastify is
 * imported so the HTTP and Fastify instrumentations can patch those modules.
 */
export function startGatewayTracing(env: GatewayEnv): Tracing {
  return startTracing({
