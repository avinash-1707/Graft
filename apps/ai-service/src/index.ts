...
/**
 * AI-service entrypoint. Tracing starts before the server module is imported so
 * the HTTP/Fastify instrumentations patch those modules; the server is then
 * loaded dynamically and started.
 */
